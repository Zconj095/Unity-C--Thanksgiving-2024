...
namespace EdgeLoreMachineLearning
{
    ...
    public class TrainValDataSplit<TInput, TOutput>
    {
        /// <summary>
        ...
        /// </summary>
        public DataSubset4<TInput, TOutput> Training { get; private set; }

        /// <summary>
        /// The validation subset of data.
        /// </summary>
        public DataSubset4<TInput, TOutput> Validation { get; private set; }
        ...
        {
            SplitIndex = index;
            Training = new DataSubset4<TInput, TOutput>(index, inputs, outputs, weights, trainIndices);
            Validation = new DataSubset4<TInput, TOutput>(index, inputs, outputs, weights, validationIndices);
        }
    }

    /// <summary>
    /// Represents a subset of data used for training or validation.
    /// </summary>
    /// <typeparam name="TInput">The type of the input data.</typeparam>
    /// <typeparam name="TOutput">The type of the output data.</typeparam>
    public class DataSubset4<TInput, TOutput>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSubset4{TInput, TOutput}" /> class.
        /// </summary>
        ...
        public DataSubset4(int index, TInput[] inputs, TOutput[] outputs, double[] weights, int[] indices)
        {
            Index = index;
            Inputs = inputs;
            Outputs = outputs;
