...
public class CelestialBodyParticleSystem : MonoBehaviour
{
    public Color auraColor = new Color(0.9f, 0.6f, 1f); // Light purple for Celestial Body
    ...
    public float auraRadius = 4.0f; // Radius of the auric ring
