...
public class EmotionalBodyParticleSystem : MonoBehaviour
{
    public Color auraColor = new Color(1f, 0.7f, 0.7f); // Light red for Emotional Body
    ...
    public float auraRadius = 2.0f; // Radius of the auric ring
