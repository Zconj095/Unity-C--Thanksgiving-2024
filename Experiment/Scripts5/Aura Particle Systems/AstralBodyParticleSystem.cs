...
public class AstralBodyParticleSystem : MonoBehaviour
{
    public Color auraColor = new Color(0.6f, 1f, 0.6f); // Light green for Astral Body
    ...
    public float auraRadius = 3.0f; // Radius of the auric ring
