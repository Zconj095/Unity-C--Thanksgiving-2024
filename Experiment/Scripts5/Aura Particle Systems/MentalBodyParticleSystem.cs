...
public class MentalBodyParticleSystem : MonoBehaviour
{
    public Color auraColor = new Color(1f, 1f, 0.6f); // Light yellow for Mental Body
    ...
    public float auraRadius = 2.5f; // Radius of the auric ring
