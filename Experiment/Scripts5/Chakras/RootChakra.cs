...
public class RootChakra : MonoBehaviour
{
    public Color chakraColor = Color.red; // Chakra color (modifiable in Inspector)
    public float chakraTransparency = 1.0f; // Transparency for the chakra (fully opaque by default)
